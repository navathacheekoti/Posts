                    ...
                    <div className="measure ">
                        ...
                        <div className="">
                            ...
                            <textarea
                                ...
                                rows="8"
                                cols="80"
                                className="w-100 b pa2 input-reset ba br-2 dark-gray"
                        ...
                        this.state.content === "" ||
                        this.state.url === "" ? (
                            <p>Please enter the title , url and content</p>
                        ) : (
                            <div className="lh-copy mt3">
                                <p
                                    className="pa3 b button"
                        ...
                        {this.state.success ? (
                            <p>Successfully submitted the post</p>
                        ) : null}
                    </div>
                </main>
                <div className="mb5">
